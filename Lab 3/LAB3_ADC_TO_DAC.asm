...
MOV 34H, #0 ; | R0 will then be incremented, which means the next row (location 36H in RAM) gets 11111B.This results in
MOV 35H, #0 ; | the first 6 rows all 0 and the last two all 1. Repeating 8 times results in the last pattern containing
